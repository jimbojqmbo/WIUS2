...
void SceneModel::Init()
{
	...
	meshList[GEO_QUAD] = MeshBuilder::GenerateQuad("Plane", glm::vec3(1.f, 1.f, 1.f), 10.f);	
...
void SceneModel::Render()
{
	...
	meshList[GEO_MODEL1]->material.kAmbient = glm::vec3(0.3f, 0.3f, 0.3f);
	meshList[GEO_MODEL1]->material.kDiffuse = glm::vec3(0.6f, 0.6f, 0.6f);
	meshList[GEO_MODEL1]->material.kSpecular = glm::vec3(0.8f, 0.8f, 0.8f);
	meshList[GEO_MODEL1]->material.kShininess = 5.0f;
	...
	//meshList[GEO_MODEL_MTL1]->material.kAmbient = glm::vec3(0.3f, 0.3f, 0.3f);
	//meshList[GEO_MODEL_MTL1]->material.kDiffuse = glm::vec3(0.6f, 0.6f, 0.6f);
	//meshList[GEO_MODEL_MTL1]->material.kSpecular = glm::vec3(0.8f, 0.8f, 0.8f);
